    ...
    categories: [
      {
        ...
        href: '#',
        links: [
          { label: 'Getting started on Vybzz Nation', href: '#' },
          { label: 'Make it your own', href: '#' },
          { label: 'Reach every fan, every time', href: '#' },
          { label: 'Showcase your work', href: '#' },
        ],
      },
      {
        ...
        href: '#',
        links: [
          { label: 'Every post, every time', href: '#' },
          { label: 'More ways to stay close', href: '#' },
          { label: 'Get to know your fans', href: '#' },
        ],
      },
      {
        ...
        href: '#',
        links: [
          { label: 'Bring in new fans', href: '#' },
          { label: 'Unlock growth', href: '#' },
    ...
    categories: [
      {
        ...
        href: '#',
        links: [
          { label: 'Powerful core features', href: '#' },
          { label: 'Earning made easy', href: '#' },
