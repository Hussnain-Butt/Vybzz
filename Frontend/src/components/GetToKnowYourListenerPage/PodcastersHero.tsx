...
const PodcastersHero: React.FC = () => {
  ...
  return (
    <section
      id="podcasters-hero"
      className="relative min-h-screen flex items-center justify-center text-center bg-black text-white overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          {/* Text is structured for professional line breaks and animation */}
          <div className="overflow-hidden">
            <span className="inline-block">Vybzz Nation for</span>
          </div>

          <div className="overflow-hidden">
            <span className="inline-block text-cyan-300">podcasters</span>
          </div>
        </h1>
        <p ref={subtitleRef} className="text-lg md:text-xl text-slate-300 mt-8 max-w-2xl mx-auto">
